...
DAYS_NO_CONNECTIVITY_MAX = 99999     # do not allow to engage after this many days
DAYS_NO_CONNECTIVITY_PROMPT = 99999  # send an offroad prompt after this many days
